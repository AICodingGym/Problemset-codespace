...
export INSTANCE_ID=matplotlib__matplotlib-26466
export REPO=matplotlib/matplotlib
export VERSION=3.7
export BASE_COMMIT=3dd06a46750d174f821df5377996f493f1af4ebb
export ENV_SETUP_COMMIT=0849036fd992a2dd133a0cffc3f84f58ccf1840f
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_text.py
