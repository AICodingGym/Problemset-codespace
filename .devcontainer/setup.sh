...
export INSTANCE_ID=sphinx-doc__sphinx-11445
export REPO=sphinx-doc/sphinx
export VERSION=7.1
export BASE_COMMIT=71db08c05197545944949d5aa76cd340e7143627
export ENV_SETUP_COMMIT=89808c6f49e1738765d18309244dca0156ee28f6
export TEST_CMD='tox --current-env -epy39 -v --'
export TEST_FILES=tests/test_util_rst.py
