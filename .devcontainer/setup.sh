...
export INSTANCE_ID=sympy__sympy-15349
export REPO=sympy/sympy
export VERSION=1.4
export BASE_COMMIT=768da1c6f6ec907524b8ebbf6bf818c92b56101b
...
export TEST_FILES=sympy/algebras/tests/test_quaternion.py
