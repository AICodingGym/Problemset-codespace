...
export INSTANCE_ID=astropy__astropy-8872
export REPO=astropy/astropy
export VERSION=3.1
export BASE_COMMIT=b750a0e6ee76fb6b8a099a4d16ec51977be46bf6
export ENV_SETUP_COMMIT=2e89d074b3b2abc2da80e437c93b1d5516a0ca57
export TEST_CMD='pytest -rA'
export TEST_FILES=astropy/units/tests/test_quantity.py
