...
export INSTANCE_ID=sympy__sympy-22080
export REPO=sympy/sympy
export VERSION=1.10
export BASE_COMMIT=3f8c8c2377cb8e0daaf8073e8d03ac7d87580813
...
export TEST_FILES='sympy/codegen/tests/test_rewriting.py sympy/printing/tests/test_pycode.py sympy/utilities/tests/test_lambdify.py'
