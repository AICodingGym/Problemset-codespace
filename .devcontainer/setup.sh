...
export INSTANCE_ID=sphinx-doc__sphinx-9229
export REPO=sphinx-doc/sphinx
export VERSION=4.1
export BASE_COMMIT=876fa81e0a038cda466925b85ccf6c5452e0f685
export ENV_SETUP_COMMIT=9a2c3c4a1559e37e95fdee88c128bb116642c897
export TEST_CMD='tox --current-env -epy39 -v --'
export TEST_FILES='tests/roots/test-ext-autodoc/target/classes.py tests/test_ext_autodoc_autoclass.py'
