...
export INSTANCE_ID=matplotlib__matplotlib-23299
export REPO=matplotlib/matplotlib
export VERSION=3.5
export BASE_COMMIT=3eadeacc06c9f2ddcdac6ae39819faa9fbee9e39
export ENV_SETUP_COMMIT=de98877e3dc45de8dd441d008f23d88738dc015d
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_rcparams.py
