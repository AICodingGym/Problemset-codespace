...
export INSTANCE_ID=astropy__astropy-13033
export REPO=astropy/astropy
export VERSION=4.3
export BASE_COMMIT=298ccb478e6bf092953bca67a3d29dc6c35f6752
export ENV_SETUP_COMMIT=298ccb478e6bf092953bca67a3d29dc6c35f6752
export TEST_CMD='pytest -rA'
export TEST_FILES=astropy/timeseries/tests/test_sampled.py
