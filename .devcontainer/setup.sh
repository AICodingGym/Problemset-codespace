...
export INSTANCE_ID=scikit-learn__scikit-learn-10297
export REPO=scikit-learn/scikit-learn
export VERSION=0.20
export BASE_COMMIT=b90661d6a46aa3619d3eec94d5281f5888add501
export ENV_SETUP_COMMIT=55bf5d93e5674f13a1134d93a11fd0cd11aabcd1
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/linear_model/tests/test_ridge.py
