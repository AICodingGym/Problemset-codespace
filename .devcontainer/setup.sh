...
export INSTANCE_ID=sphinx-doc__sphinx-8269
export REPO=sphinx-doc/sphinx
export VERSION=3.3
export BASE_COMMIT=1e2ccd8f0eca0870cf6f8fce6934e2da8eba9b72
export ENV_SETUP_COMMIT=3b85187ffa3401e88582073c23188c147857a8a3
export TEST_CMD='tox --current-env -epy39 -v --'
export TEST_FILES='tests/roots/test-linkcheck-localserver/conf.py tests/roots/test-linkcheck-localserver/index.rst tests/test_build_linkcheck.py'
