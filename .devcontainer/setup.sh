...
export INSTANCE_ID=django__django-14311
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=5a8e8f80bb82a867eab7e4d9d099f21d0a976d22
...
export TEST_FILES='tests/utils_tests/test_autoreload.py tests/utils_tests/test_module/main_module.py'
