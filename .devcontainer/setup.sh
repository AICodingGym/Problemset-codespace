...
export INSTANCE_ID=astropy__astropy-13579
export REPO=astropy/astropy
export VERSION=5.0
export BASE_COMMIT=0df94ff7097961e92fd7812036a24b145bc13ca8
export ENV_SETUP_COMMIT=cdf311e0714e611d48b0a31eb1f0e2cbffab7f23
export TEST_CMD='pytest -rA'
export TEST_FILES=astropy/wcs/wcsapi/wrappers/tests/test_sliced_wcs.py
