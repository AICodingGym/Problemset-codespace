...
export INSTANCE_ID=sphinx-doc__sphinx-8056
export REPO=sphinx-doc/sphinx
export VERSION=3.2
export BASE_COMMIT=e188d56ed1248dead58f3f8018c0e9a3f99193f7
export ENV_SETUP_COMMIT=f92fa6443fe6f457ab0c26d41eb229e825fda5e1
export TEST_CMD='tox --current-env -epy39 -v --'
export TEST_FILES=tests/test_ext_napoleon_docstring.py
