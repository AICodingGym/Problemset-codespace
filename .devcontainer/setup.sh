...
export INSTANCE_ID=django__django-15569
export REPO=django/django
export VERSION=4.1
export BASE_COMMIT=884b4c27f506b3c29d58509fc83a35c30ea10d94
...
export TEST_FILES='tests/custom_lookups/tests.py tests/model_fields/test_jsonfield.py tests/schema/tests.py'
