...
export INSTANCE_ID=matplotlib__matplotlib-24637
export REPO=matplotlib/matplotlib
export VERSION=3.6
export BASE_COMMIT=a9ba9d5d3fe9d5ac15fbdb06127f97d381148dd0
export ENV_SETUP_COMMIT=73909bcb408886a22e2b84581d6b9e6d9907c813
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_backend_svg.py
...
sudo apt-get -y update && sudo apt-get -y upgrade && DEBIAN_FRONTEND=noninteractive sudo apt-get install -y imagemagick ffmpeg texlive texlive-latex-extra texlive-fonts-recommended texlive-xetex texlive-luatex cm-super dvipng
