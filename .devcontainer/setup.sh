...
export INSTANCE_ID=pytest-dev__pytest-6197
export REPO=pytest-dev/pytest
export VERSION=5.2
export BASE_COMMIT=e856638ba086fcf5bebf1bebea32d5cf78de87b4
export ENV_SETUP_COMMIT=f36ea240fe3579f945bf5d6cc41b5e45a572249d
export TEST_CMD='pytest -rA'
export TEST_FILES='testing/test_collection.py testing/test_skipping.py'
