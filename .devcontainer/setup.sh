...
export INSTANCE_ID=scikit-learn__scikit-learn-14496
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=d49a6f13af2f22228d430ac64ac2b518937800d0
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/cluster/tests/test_optics.py
