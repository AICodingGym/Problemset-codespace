...
export INSTANCE_ID=matplotlib__matplotlib-23412
export REPO=matplotlib/matplotlib
export VERSION=3.5
export BASE_COMMIT=f06c2c3abdaf4b90285ce5ca7fedbb8ace715911
export ENV_SETUP_COMMIT=de98877e3dc45de8dd441d008f23d88738dc015d
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_patches.py
