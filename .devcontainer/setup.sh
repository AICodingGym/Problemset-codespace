...
export INSTANCE_ID=pytest-dev__pytest-5631
export REPO=pytest-dev/pytest
export VERSION=5.0
export BASE_COMMIT=cb828ebe70b4fa35cd5f9a7ee024272237eab351
export ENV_SETUP_COMMIT=c2f762460f4c42547de906d53ea498dd499ea837
export TEST_CMD='pytest -rA'
export TEST_FILES=testing/python/integration.py
