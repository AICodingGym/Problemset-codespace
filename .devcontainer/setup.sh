...
export INSTANCE_ID=sympy__sympy-13091
export REPO=sympy/sympy
export VERSION=1.1
export BASE_COMMIT=d1320814eda6549996190618a21eaf212cfd4d1e
...
export TEST_FILES='sympy/core/tests/test_basic.py sympy/core/tests/test_numbers.py'
