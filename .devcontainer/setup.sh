...
export INSTANCE_ID=scikit-learn__scikit-learn-14141
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=3d997697fdd166eff428ea9fd35734b6a8ba113e
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/utils/tests/test_show_versions.py
