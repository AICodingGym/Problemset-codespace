...
export INSTANCE_ID=django__django-15022
export REPO=django/django
export VERSION=4.1
export BASE_COMMIT=e1d673c373a7d032060872b690a92fc95496612e
...
export TEST_FILES='tests/admin_changelist/admin.py tests/admin_changelist/tests.py'
