...
export INSTANCE_ID=scikit-learn__scikit-learn-14894
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=fdbaa58acbead5a254f2e6d597dc1ab3b947f4c6
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/svm/tests/test_svm.py
