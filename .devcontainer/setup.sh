...
export INSTANCE_ID=django__django-16429
export REPO=django/django
export VERSION=4.2
export BASE_COMMIT=6c86495bcee22eac19d7fb040b2988b830707cbd
...
export TEST_FILES=tests/utils_tests/test_timesince.py
