...
export INSTANCE_ID=scikit-learn__scikit-learn-26194
export REPO=scikit-learn/scikit-learn
export VERSION=1.3
export BASE_COMMIT=e886ce4e1444c61b865e7839c9cff5464ee20ace
export ENV_SETUP_COMMIT=1e8a5b833d1b58f3ab84099c4582239af854b23a
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/metrics/tests/test_ranking.py
