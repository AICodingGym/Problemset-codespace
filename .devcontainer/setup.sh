...
export INSTANCE_ID=django__django-14089
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=d01709aae21de9cd2565b9c52f32732ea28a2d98
...
export TEST_FILES=tests/utils_tests/test_datastructures.py
