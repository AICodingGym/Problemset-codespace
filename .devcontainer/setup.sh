...
export INSTANCE_ID=scikit-learn__scikit-learn-13135
export REPO=scikit-learn/scikit-learn
export VERSION=0.21
export BASE_COMMIT=a061ada48efccf0845acae17009553e01764452b
export ENV_SETUP_COMMIT=7813f7efb5b2012412888b69e73d76f2df2b50b6
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/preprocessing/tests/test_discretization.py
