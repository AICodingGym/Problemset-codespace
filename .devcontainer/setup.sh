...
export INSTANCE_ID=sympy__sympy-14531
export REPO=sympy/sympy
export VERSION=1.1
export BASE_COMMIT=205da797006360fc629110937e39a19c9561313e
...
export TEST_FILES='sympy/printing/tests/test_python.py sympy/printing/tests/test_str.py'
