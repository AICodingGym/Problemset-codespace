...
export INSTANCE_ID=matplotlib__matplotlib-22865
export REPO=matplotlib/matplotlib
export VERSION=3.5
export BASE_COMMIT=c6c7ec1978c22ae2c704555a873d0ec6e1e2eaa8
export ENV_SETUP_COMMIT=de98877e3dc45de8dd441d008f23d88738dc015d
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_colorbar.py
