...
export INSTANCE_ID=matplotlib__matplotlib-24570
export REPO=matplotlib/matplotlib
export VERSION=3.6
export BASE_COMMIT=8f0003ae902952372824c9917975fb372c026a42
export ENV_SETUP_COMMIT=73909bcb408886a22e2b84581d6b9e6d9907c813
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_offsetbox.py
