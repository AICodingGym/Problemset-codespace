...
export INSTANCE_ID=django__django-16819
export REPO=django/django
export VERSION=5.0
export BASE_COMMIT=0b0998dc151feb77068e2387c34cc50ef6b356ae
...
export TEST_FILES=tests/migrations/test_optimizer.py
