...
export INSTANCE_ID=sympy__sympy-19783
export REPO=sympy/sympy
export VERSION=1.7
export BASE_COMMIT=586a43201d0357e92e8c93548d69a9f42bf548f4
...
export TEST_FILES='sympy/physics/quantum/tests/test_dagger.py sympy/physics/quantum/tests/test_operator.py'
