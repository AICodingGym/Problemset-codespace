...
export INSTANCE_ID=django__django-14170
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=6efc35b4fe3009666e56a60af0675d7d532bf4ff
...
export TEST_FILES=tests/db_functions/datetime/test_extract_trunc.py
