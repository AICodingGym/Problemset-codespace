...
export INSTANCE_ID=scikit-learn__scikit-learn-14053
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=6ab8c86c383dd847a1be7103ad115f174fe23ffd
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/tree/tests/test_export.py
