...
export INSTANCE_ID=django__django-14140
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=45814af6197cfd8f4dc72ee43b90ecde305a1d5a
...
export TEST_FILES='tests/expressions/tests.py tests/queries/test_q.py tests/queryset_pickle/tests.py'
