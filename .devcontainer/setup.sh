...
export INSTANCE_ID=astropy__astropy-14365
export REPO=astropy/astropy
export VERSION=5.1
export BASE_COMMIT=7269fa3e33e8d02485a647da91a5a2a60a06af61
export ENV_SETUP_COMMIT=5f74eacbcc7fff707a44d8eb58adaa514cb7dcb5
export TEST_CMD='pytest -rA'
export TEST_FILES=astropy/io/ascii/tests/test_qdp.py
