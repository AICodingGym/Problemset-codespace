...
export INSTANCE_ID=astropy__astropy-13977
export REPO=astropy/astropy
export VERSION=5.1
export BASE_COMMIT=5250b2442501e6c671c6b380536f1edb352602d1
export ENV_SETUP_COMMIT=5f74eacbcc7fff707a44d8eb58adaa514cb7dcb5
export TEST_CMD='pytest -rA'
export TEST_FILES='astropy/units/tests/test_quantity.py astropy/units/tests/test_quantity_ufuncs.py'
