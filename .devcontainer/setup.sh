...
export INSTANCE_ID=mwaskom__seaborn-3187
export REPO=mwaskom/seaborn
export VERSION=0.12
export BASE_COMMIT=22cdfb0c93f8ec78492d87edb810f10cb7f57a31
export ENV_SETUP_COMMIT=d25872b0fc99dbf7e666a91f59bd4ed125186aa1
export TEST_CMD='pytest --no-header -rA'
export TEST_FILES='tests/_core/test_plot.py tests/test_relational.py'
