...
export INSTANCE_ID=django__django-16493
export REPO=django/django
export VERSION=5.0
export BASE_COMMIT=e3a4cee081cf60650b8824f0646383b79cb110e7
...
export TEST_FILES='tests/file_storage/models.py tests/file_storage/tests.py'
