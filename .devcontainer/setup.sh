...
export INSTANCE_ID=django__django-14007
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=619f26d2895d121854b1bed1b535d42b722e2eba
...
export TEST_FILES='tests/custom_pk/fields.py tests/custom_pk/models.py tests/custom_pk/tests.py'
