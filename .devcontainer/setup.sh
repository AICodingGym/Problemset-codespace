...
export INSTANCE_ID=sympy__sympy-20154
export REPO=sympy/sympy
export VERSION=1.7
export BASE_COMMIT=bdb49c4abfb35554a3c8ce761696ffff3bb837fe
...
export TEST_FILES=sympy/utilities/tests/test_iterables.py
