...
export INSTANCE_ID=scikit-learn__scikit-learn-15100
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=af8a6e592a1a15d92d77011856d5aa0ec4db4c6c
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/feature_extraction/tests/test_text.py
