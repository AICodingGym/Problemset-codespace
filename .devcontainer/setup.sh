...
export INSTANCE_ID=django__django-16256
export REPO=django/django
export VERSION=4.2
export BASE_COMMIT=76e37513e22f4d9a01c7f15eee36fe44388e6670
...
export TEST_FILES='tests/async/models.py tests/async/test_async_related_managers.py tests/generic_relations/tests.py'
