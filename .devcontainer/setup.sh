...
export INSTANCE_ID=django__django-15103
export REPO=django/django
export VERSION=4.1
export BASE_COMMIT=dd528cb2cefc0db8b91a7ff0a2bc87305b976597
...
export TEST_FILES='tests/template_tests/filter_tests/test_json_script.py tests/utils_tests/test_html.py'
