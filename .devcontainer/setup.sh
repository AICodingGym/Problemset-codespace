...
export INSTANCE_ID=scikit-learn__scikit-learn-13142
export REPO=scikit-learn/scikit-learn
export VERSION=0.21
export BASE_COMMIT=1c8668b0a021832386470ddf740d834e02c66f69
export ENV_SETUP_COMMIT=7813f7efb5b2012412888b69e73d76f2df2b50b6
export TEST_CMD='pytest -rA'
export TEST_FILES='sklearn/mixture/tests/test_bayesian_mixture.py sklearn/mixture/tests/test_gaussian_mixture.py'
