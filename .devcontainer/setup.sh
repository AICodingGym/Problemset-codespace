...
export INSTANCE_ID=astropy__astropy-14369
export REPO=astropy/astropy
export VERSION=5.1
export BASE_COMMIT=fa4e8d1cd279acf9b24560813c8652494ccd5922
export ENV_SETUP_COMMIT=5f74eacbcc7fff707a44d8eb58adaa514cb7dcb5
export TEST_CMD='pytest -rA'
export TEST_FILES=astropy/units/tests/test_format.py
