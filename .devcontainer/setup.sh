...
export INSTANCE_ID=matplotlib__matplotlib-22719
export REPO=matplotlib/matplotlib
export VERSION=3.5
export BASE_COMMIT=a2a1b0a11b993fe5f8fab64b6161e99243a6393c
export ENV_SETUP_COMMIT=de98877e3dc45de8dd441d008f23d88738dc015d
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_category.py
