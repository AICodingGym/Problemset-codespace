...
export INSTANCE_ID=scikit-learn__scikit-learn-14629
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=4aded39b5663d943f6a4809abacfa9cae3d7fb6a
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/tests/test_multioutput.py
