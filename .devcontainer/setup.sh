...
export INSTANCE_ID=matplotlib__matplotlib-25122
export REPO=matplotlib/matplotlib
export VERSION=3.6
export BASE_COMMIT=5ec2bd279729ff534719b8bf238dbbca907b93c5
export ENV_SETUP_COMMIT=73909bcb408886a22e2b84581d6b9e6d9907c813
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_mlab.py
