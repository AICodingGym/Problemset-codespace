...
export INSTANCE_ID=sympy__sympy-12419
export REPO=sympy/sympy
export VERSION=1.0
export BASE_COMMIT=479939f8c65c8c2908bbedc959549a257a7c0b0b
...
export TEST_FILES=sympy/matrices/expressions/tests/test_matexpr.py
