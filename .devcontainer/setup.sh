...
export INSTANCE_ID=matplotlib__matplotlib-26342
export REPO=matplotlib/matplotlib
export VERSION=3.7
export BASE_COMMIT=2aee6ccd7c7e1f8d282c1e7579f4ee546b838542
export ENV_SETUP_COMMIT=0849036fd992a2dd133a0cffc3f84f58ccf1840f
export TEST_CMD='pytest -rA'
export TEST_FILES=lib/matplotlib/tests/test_contour.py
