...
export INSTANCE_ID=django__django-14752
export REPO=django/django
export VERSION=4.0
export BASE_COMMIT=b64db05b9cedd96905d637a2d824cbbf428e40e7
...
export TEST_FILES=tests/admin_views/test_autocomplete_view.py
