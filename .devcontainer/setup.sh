...
export INSTANCE_ID=scikit-learn__scikit-learn-9288
export REPO=scikit-learn/scikit-learn
export VERSION=0.22
export BASE_COMMIT=3eacf948e0f95ef957862568d87ce082f378e186
export ENV_SETUP_COMMIT=7e85a6d1f038bbb932b36f18d75df6be937ed00d
export TEST_CMD='pytest -rA'
export TEST_FILES=sklearn/cluster/tests/test_k_means.py
